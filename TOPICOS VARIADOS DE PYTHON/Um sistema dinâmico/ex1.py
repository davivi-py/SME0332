...
def verlet_velocidade(r1_0, v1_0, r2_0, v2_0, m1, m2, gamma, dt, N_steps):
    r1 = np.array(r1_0)
    v1 = np.array(v1_0)
    r2 = np.array(r2_0)
    v2 = np.array(v2_0)
    
    historico = np.zeros((N_steps, 9))
    ...
    for n in range(N_steps):
        ...
        historico[n] = [n*dt, r1[0], r1[1], v1[0], v1[1], r2[0], r2[1], v2[0], v2[1]]
...
resultado = verlet_velocidade(r1_0, v1_0, r2_0, v2_0, m1, m2, gamma, dt, N_steps)
print(resultado[:5])
