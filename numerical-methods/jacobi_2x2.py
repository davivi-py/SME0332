-e """
Jacobi Solver — 2×2 System
============================
Applies Jacobi iteration to a 2×2 linear system and plots the number
of iterations required to converge as a function of tolerance ε.
"""
