-e """
2D Random Walk & Mean Squared Displacement
============================================
Simulates 2D random walks and computes the Mean Squared Displacement (MSD)
averaged over M independent realizations.
"""
import numpy as np 
