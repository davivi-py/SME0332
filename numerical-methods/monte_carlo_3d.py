-e """
3D Monte Carlo π Estimation
=============================
Estimates π by sampling random points in a unit cube and checking
whether they fall inside the inscribed sphere. π ≈ 6 * (points inside / total).
"""
import numpy as np
