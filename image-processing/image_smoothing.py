...
========================
Implements and compares two manual convolution smoothing approaches:
  - Cross-shaped kernel (5-neighbor average)
  - 3×3 kernel (9-neighbor average)
Applied iteratively to a synthetic noisy image.
"""
